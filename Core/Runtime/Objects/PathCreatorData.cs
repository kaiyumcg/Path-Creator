...
namespace PathCreation {
    ...
    [System.Serializable]
    public class PathCreatorData : ICloneable
    {
        ...
        [SerializeField] VertexPath _vertexPath;

        [SerializeField]
        bool vertexPathUpToDate;
        public VertexPath VertPath { get { return _vertexPath; } }
        ...
        public int tabIndex;
        internal PathCreatorData() { }

        public object Clone()
        {
            var newinst = new PathCreatorData(this);
            return newinst;
        }
        internal PathCreatorData(PathCreatorData old)
        {
            _bezierPath = old._bezierPath.Clone() as BezierPath;
            _vertexPath = old._vertexPath.Clone() as VertexPath;
            vertexPathUpToDate = old.vertexPathUpToDate;
            vertexPathMaxAngleError = old.vertexPathMaxAngleError;
            vertexPathMinVertexSpacing = old.vertexPathMinVertexSpacing;
            showTransformTool = old.showTransformTool;

            showPathBounds = old.showPathBounds;
            showPerSegmentBounds = old.showPerSegmentBounds;
            displayAnchorPoints = old.displayAnchorPoints;
            displayControlPoints = old.displayControlPoints;
            bezierHandleScale = old.bezierHandleScale;
            globalDisplaySettingsFoldout = old.globalDisplaySettingsFoldout;
            keepConstantHandleSize = old.keepConstantHandleSize;

            // vertex display settings
            showNormalsInVertexMode = old.showNormalsInVertexMode;
            showBezierPathInVertexMode = old.showBezierPathInVertexMode;

            // Editor display states
            showDisplayOptions = old.showDisplayOptions;
            showPathOptions = old.showPathOptions;
            showVertexPathDisplayOptions = old.showVertexPathDisplayOptions;
            showVertexPathOptions = old.showVertexPathOptions;
            showNormals = old.showNormals;
            showNormalsHelpInfo = old.showNormalsHelpInfo;
