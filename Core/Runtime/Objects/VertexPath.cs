...
namespace PathCreation {
    ...
    public class VertexPath : ICloneable
    
    {
        #region Fields

        [SerializeField] public PathSpace space;
        [SerializeField] public bool isClosedLoop;
        [SerializeField] public Vector3[] localPoints;
        [SerializeField] public Vector3[] localTangents;
        [SerializeField] public Vector3[] localNormals;
        ...
        [SerializeField] public float[] cumulativeLengthAtEachVertex;
        ...
        public object Clone()
        {
            var newinst = new VertexPath(this);
            return newinst;
        }
        internal VertexPath(VertexPath old) 
        {
            space = old.space;
