...
namespace PathCreation {
    ...
    [System.Serializable]
    public class BezierPath : ICloneable
    {
 ...
 [SerializeField] PathSpace space;
 [SerializeField] ControlMode controlMode;
 [SerializeField] float autoControlLength = .3f;
 [SerializeField] bool boundsUpToDate;
 [SerializeField] Bounds bounds;

 // Normals settings
 [SerializeField] List<float> perAnchorNormalsAngle;
 [SerializeField] float globalNormalsAngle;
 [SerializeField] bool flipNormals;
